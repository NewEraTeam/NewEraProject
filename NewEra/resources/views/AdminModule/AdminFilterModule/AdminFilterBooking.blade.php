        ...
        <div class="mb-8 p-6 bg-white rounded-lg shadow-md">
            ...
            <div class="flex justify-center space-x-4 mb-4">
                <div class="flex items-center flex-grow">
                    <select id="filterVenue" class="bg-white text-black px-4 py-2 rounded hover:bg-white-600 shadow-md border border-gray-600 w-full">
                ...
                <div class="flex items-center flex-grow">
                    <input type="date" id="filterDate" class="border border-gray-600 rounded px-4 py-2 w-full shadow-md" />
                </div>
                <button id="filterButton" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600 shadow-md">Filter</button>
            </div>
        </div>

        <div class="p-6 bg-white rounded-lg shadow-md">
            <h2 class="text-xl font-semibold mb-4">View and Manage Bookings</h2>
            ...
            <div class="flex justify-end mt-4">
                <button id="updateButton" class="bg-green-500 text-white px-4 py-2 rounded hover:bg-green-600 shadow-md">Update Selected</button>
            </div>
        </div>
    </main>
